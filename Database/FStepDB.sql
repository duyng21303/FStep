...
CREATE TABLE Chat (id_chat int IDENTITY NOT NULL, chat_msg nvarchar(255) NULL, chat_date datetime NULL, reciever_user_id nvarchar(7) NULL, sender_user_id nvarchar(50) NOT NULL, id_post int NOT NULL, PRIMARY KEY (id_chat));
CREATE TABLE Comment (id_comment int IDENTITY NOT NULL, content nvarchar(255) NULL, [date] datetime NULL, id_post int NOT NULL, id_user nvarchar(50) NOT NULL, PRIMARY KEY (id_comment));
...
CREATE TABLE Payment (id_payment int IDENTITY NOT NULL, pay_time datetime NULL, amount float(10) NULL, external_momo_transaction_code nvarchar(255) NULL, id_transaction int NOT NULL, PRIMARY KEY (id_payment));
CREATE TABLE Post (id_post int IDENTITY NOT NULL, content nvarchar(255) NULL, [date] datetime NULL, img nvarchar(255) NULL, status bit NULL, type nvarchar(20) NOT NULL, detail ntext NULL, id_product int NULL, id_user nvarchar(50) NOT NULL, PRIMARY KEY (id_post));
CREATE TABLE Product (id_product int IDENTITY NOT NULL, name nvarchar(255) NULL, quantity int NULL, price float(10) NULL, received_seller_date datetime NULL, sent_buyer_date datetime NULL, status bit NULL, detail ntext NULL, recieve_img nvarchar(255) NULL, sent_img nvarchar(255) NULL, PRIMARY KEY (id_product));
...
CREATE TABLE [Transaction] (id_transaction int IDENTITY NOT NULL, [date] datetime NULL, status bit NULL, quantity int NULL, amount float(10) NULL, note nvarchar(255) NULL, id_post int NOT NULL, id_user_buyer nvarchar(50) NOT NULL, id_user_seller nvarchar(7) NOT NULL, type int NULL, code_transaction nvarchar(255) NULL, PRIMARY KEY (id_transaction));
CREATE TABLE [User] (id_user nvarchar(50) NOT NULL, status bit NULL, name nvarchar(40) NULL, avatar_img nvarchar(255) NULL, address nvarchar(100) NULL, email nvarchar(50) NULL, password nvarchar(50) NOT NULL, student_id nvarchar(10) NULL, create_date datetime NULL, rating int NULL, role nvarchar(30) NOT NULL, token_google nvarchar(255) NULL, hash_key nvarchar(255) NULL, gender nvarchar(255) NULL, PRIMARY KEY (id_user));
