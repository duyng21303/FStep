...
CREATE TABLE Notification_ (id_notification int IDENTITY NOT NULL, [date] datetime NULL, content nvarchar(255) NULL, name nvarchar(255) NULL, type nvarchar(50) NULL, id_user nvarchar(50) NULL, id_report int NULL, id_comment int NULL, id_payment int NULL, id_transaction int NULL, PRIMARY KEY (id_notification));
...
CREATE TABLE Post (id_post int IDENTITY NOT NULL, content nvarchar(255) NULL, [date] datetime NULL, img nvarchar(255) NULL, status nvarchar(255) NULL, type nvarchar(20) NOT NULL, detail ntext NULL, location nvarchar(255) NULL, id_product int NULL, id_user nvarchar(50) NOT NULL, category nvarchar(255) NULL, PRIMARY KEY (id_post));
...
ALTER TABLE Notification_ ADD CONSTRAINT FKNotificati705209 FOREIGN KEY (id_user) REFERENCES [User] (id_user);
...
ALTER TABLE Notification_ ADD CONSTRAINT FKNotificati7617 FOREIGN KEY (id_report) REFERENCES Report (id_report);
ALTER TABLE Notification_ ADD CONSTRAINT FKNotificati91580 FOREIGN KEY (id_comment) REFERENCES Comment (id_comment);
ALTER TABLE Notification_ ADD CONSTRAINT FKNotificati364891 FOREIGN KEY (id_payment) REFERENCES Payment (id_payment);
ALTER TABLE Notification_ ADD CONSTRAINT FKNotificati255672 FOREIGN KEY (id_transaction) REFERENCES [Transaction] (id_transaction);
